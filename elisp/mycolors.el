;;; based on color-theme-library.el --- The real color theme functions
...
(defun color-theme-chirag-gnus ()
  "GNUS color theme by Chirag Kantharia"
  (interactive)
  (color-theme-install
   '(color-theme-chirag-gnus
     (default ((t (nil))))
     (bold ((t (:bold t))))
     ...
     (gnus-summary-high-unread-face ((t (:bold t :foreground "red"))))
